  ...
  <div class="wrap">
    ...
    {% for webinar in webinars %}
      ...
      {% if webinar_date >= today and webinar.published != false %}
        ...
        {% include webinar_card.html webinar=webinar mode="upcoming" abstract_limit=home_upcoming_abstract_limit details_label="Details & resources" core_actions_only=true %}
      {% endif %}
    {% endfor %}
    </div>
